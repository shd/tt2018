...
\item Дизъюнкция.
Если $\varphi \vee \psi \equiv \forall \alpha.(\varphi\rightarrow\alpha)\rightarrow(\psi\rightarrow\alpha)\rightarrow\psi$,
...
$$\infer{\Gamma\vdash\pi}{\Gamma\vdash\varphi\rightarrow\pi\quad\Gamma\vdash\psi\rightarrow\pi\quad\Gamma\vdash\varphi\vee\psi}$$
\end{tabular}\end{center}
...
%\item Напомним, что чёрчевские нумералы представляются в системе F так:
%... 
%\item Выведите тип для логических выражений. 
%... <<ещё добавится
\end{enumerate}
